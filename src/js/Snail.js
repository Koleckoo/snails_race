export class Snail {
    constructor(properties) {
        ...
        this.speed = properties.velocity + "px";
    ...
    moveSnail = () => {
        this.element.style.transform += `translateX(${this.speed})`
    }

    changeColor = () => {
        const shell = this.element.querySelector(".snail__shell");
        shell.style.fill = `${this.color}`
    }
